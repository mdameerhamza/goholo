...
<div class="page-content-col">
	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				<span class="caption-subject font-blue-hoki bold uppercase">Add Marketing Member</span>
			</div>
			<div class="tools">
		...
		<div class="portlet-body form">
			<!-- BEGIN FORM-->
			<form action="<?php  echo base_url() ?>recruitments/manage_user" method="post" enctype="multipart/form-data" class="horizontal-form">
				<div class="form-body">
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input type="text" name="paypal_id" class="form-control paypal_id" value="<?php echo (set_value('paypal_id'));   ?>"> </div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6 user_commission_div">
									...
									<div class="form-group">
										...
										<input id="royalty" name="user_commission" class="form-control user_commission" min="15" value="<?php echo $user_commission;   ?>" type="number"> 
									</div>
								</div>
							</div>
